...
*We hypothesize that heart rate will increase and HRV decrease during both stress and recovery phases of acute mental stress challenge as compared to the rest phase.*
...
1. Determine the relationship of baseline resting cardiac autonomic dysfunction with obstructive coronary artery disease (>70% stenosis) in a cohort of high-risk patients undergoing coronary angiography. 
*We hypothesize that short-term autonomic metrics will be in lower in subjects with obstructive, epicardial disease compared to those without evidence of obstructive CAD.*
...
*We hypothesize that in subjects undergoing revascularization of the coronary arteries, short-term HRV will be lower after revascularization as compared to before revascularization and also compared to HRV during angiography.*
1. Determine the relationship between autonomic dysfunction and perfusion abnormalities in response to conventional stress-induced myocardial ischemia in a cohot of participants with known CAD. 
