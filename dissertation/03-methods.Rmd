...
*We hypothesize that short-term autonomic metrics will be lower during both stress and recovery phases of acute mental stress challenge as compared to the rest phase.*
1. Explore the relationship of autonomic dysfunction at time of acute mental stress with chronic mental stress. 
*We hypothesize that lower measures of short-term stress reactivity autonomic metrics will have an association with depression and PTSD.*
1. Determine the relationship between autonomic dysfunction and chronic mental stress. 
*We hypothesize that lower early morning autonomic metrics will have an increased risk for depression and PTSD. We hypothesize that lower circadian autonomic variability will have an association for depression and PTSD.*
...
*We hypothesize that short-term autonomic metrics will be in lower in subjects with obstructive, epicardial disease.*
1. Explore the effect of revascularization of obstructive coronary artery disease with changes in autonomic function. 
*We hypothesize that in subjects undergoing revascularization of the coronary arteries, short-term autonomic metrics will be higher after revascularization as compared to before revascularization.*
1. Determine the relationship between autonomic dysfunction and perfusion abnormalities in response to physical stress. 
*We hypothesize that lower early morning and stress reactivity autonomic metrics will associate with abnormal myocardial perfusion from physical stress.*
...
*We hypothesize that lower early morning autonomic dysfunction will be associated with lower myocardial blood flow, as measured by coronary flow reserve, after pharmacological stress.*
*We hypothesize that circadian autonomic variability will be associated with lower coronary flow reserve.*
...
*We hypothesize that lower stress reactivity autonomic metrics will be associated with abnormalities in myocardial perfusion.*  
*We hypothesize that this relationship will not be affected by the chronic mental stress of depression and PTSD.*
...
*We hypothesize that lower early morning autonomic metrics and circadian autonomic variability will be associated with increased hazard for overall and cardiovascular mortality.*
1. Explore the relationship of stress-induced autonomic dysfunction on the risk of major adverse cardiovascular events.
*We hypothesize that stress reactivity autonomic metrics will be associated with an increased hazard for cardiovascular mortality and recurrent cardiovascular events.*
*We hypothesize that this relationship will not be explained by mental stress-induced myocardial ischemia.*
...
Morphological assessment of ECG changes were also performed in the *MIMS/MIPS* with T-wave area.
