...
- **AIM #4: To explore the utility of advanced harmonic regression modeling and feature reduction methods to quantify circadian changes in ANS dysfunction.**  
...
**AIM #2: To determine if ANS dysfunction mediates the relationship of acute/chronic $\Psi$ distress and CAD, measured by MPI and cardiac catheterization.**  
*Hypothesis: 1) HRV will be associated with both acute and chronic stress. 2) HRV will be associated with abnormal MPI and obstructive CAD. 3) The association between stress reactivity and abnormal MPI will be mediated by HRV.*
