...
- Effect of .violet[acute and chronic psychological stress] on .teal[autonomic dysfunction]
...
hrv <- ggsurvplot(
	...
	legend = "bottom", legend.title = "Low Frequency HRV", legend.labs = c("Low", "High"),
