...
Depression is associated with both circadian disruption and decreased awakening cortisol [@Dedovic2015], and depressive symptom burden has a level of diurnal variation [@Wirz-Justice2008], which may both be quantified by autonomic metrics.
PTSD is similar in that there are significant changes in sleep-wake cycles, which has not yet been explored on its relationship with autonomic dysfunction [@Walker2020]. 

## Myocardial Ischemia

In **Aim II**, we studied the autonomic mechanisms underlying ischemic heart disease.
This builds off of our findings of the association of autonomic dysfunction and physical stress-induced myocardial ischemia, particularly adding depth by evaluating coronary flow reserve and expanding on the circadian patterns previously described [@Shah2020].
Our most important findings were that autonomic responses to acute stress were strongly associated with MSIMI, and that circadian autonomic variability was associated with coronary flow reserve.
Additionally, there was no association between epicardial disease and autonomic dysfunction.
This supports that important role autonomic regulation plays in cardiovascular physiology, particularly that of coronary vasomotor and microvascular regulation, providing insight into different facets of IHD. 
...
We found that for every SD decrease in certain HRV metrics, there was a 3--4 times increase in the hazard ratio for mortality.
In comparison, hyperlipidemia with low density lipoprotein $\ge$ 200 only have a hazard ratio ranging from 1.3 -- 1.8 [@Abdullah2018].
...
Current clinical practice ignores autonomic function and behavioral therapies for the most part, which leads to an entire spectrum of disease without adequate research and therapies.
